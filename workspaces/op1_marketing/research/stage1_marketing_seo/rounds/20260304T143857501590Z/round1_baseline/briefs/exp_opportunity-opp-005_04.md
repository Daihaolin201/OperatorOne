...
## Context summary
- ICP: SMB owner / finance admin / General SMB / 10-100
- Problem: Expense reimbursement remains chaotic and fraud-prone with manual checks.
- Value proposition: Shared sheet + end-of-month manual reconciliation.
