...
## Mode
- Framework-first setup mode enabled via `BOOTSTRAP.md`.

## Framework files
- `framework/product-selection-framework.md`
- `framework/pipeline.md`
- `framework/agent-capability-model.md`
- `framework/templates/*.template.json`

## Skills installed
- `skills/op1-product-idea-discovery/SKILL.md`
- `skills/op1-product-idea-screening/SKILL.md`
- `skills/op1-product-mvp-scope/SKILL.md`
