...
def main() -> int:
    ...
    if args.mode == "commit":
        ...
        handoff = _read_json(sales_handoff, default={
            ...
            "generated_at": _now_iso(),
            "generated_by": "workspaces/op1_sales/skills/send-outreach-stage2/scripts/process_outreach_replies_stage2.py",
        ...
        handoff["generated_by"] = "workspaces/op1_sales/skills/send-outreach-stage2/scripts/process_outreach_replies_stage2.py"
