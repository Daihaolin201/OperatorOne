    ...
    if args.mode == "commit":
        ...
        handoff = read_json(
            ...
            default={
                ...
                "generated_at": now_iso(),
                "generated_by": "workspaces/op1_sales/scripts/render_conversion_scoreboard_stage3.py",
        ...
        handoff["generated_by"] = "workspaces/op1_sales/scripts/render_conversion_scoreboard_stage3.py"
