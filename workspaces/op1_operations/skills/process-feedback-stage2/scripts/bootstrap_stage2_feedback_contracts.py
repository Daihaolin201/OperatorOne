#!/usr/bin/env python3
"""Bootstrap Stage2 feedback config/contracts into op1_operations workspace."""
...
from stage2_feedback_common import now_iso, resolve_repo_root


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Bootstrap Stage2 feedback defaults")
...
def main() -> int:
    ...
    file_map = {
        template_dir / "feedback_source_adapters.v1.json": op_ws / "config/feedback_source_adapters.v1.json",
        template_dir / "feedback_priority_weights.v1.yaml": op_ws / "config/feedback_priority_weights.v1.yaml",
        template_dir / "feedback_contract.v1.json": op_ws / "contracts/feedback_contract.v1.json",
        template_dir / "feedback_taxonomy.v1.yaml": op_ws / "contracts/feedback_taxonomy.v1.yaml",
        template_dir / "manual_feedback_notes.latest.jsonl": op_ws / "research/stage2_feedback/manual_feedback_notes.latest.jsonl",
    }
